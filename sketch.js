...
function draw() {
  ...
  text(currentDate, 825, 450);//tanggal
  textSize(60);
  text(currentTime, 790 ,405);//waktu


  textSize(25)
  textFont(f1)
  fill('black')
  text("A. Profil Desa Kota Dalam",10,955)
  image(profil,35,990,455,315);
  textSize(20)
  textFont(f2)
  text("Desa Kota Dalam adalah salat satu Desa Tua di Kecamatan Sidomulyo yang didirikan pada ",515,1005)
  ...
  text("- Sebelah Selatan : Berbatsana dengan Desa Merak Belantung ",515,1095)
  text("- Sebelah Timur : Berbatasan dengan Kolonisasi ",515,1125)
  text("- Sebelah Barat : Berbatasan dengan Desa Suak Labuhan ",515,1155)
  text("Dimana waktu itu penduduknya pindahan dari Ketibung (sekarang Desa Sidoasri) ",515,1185)
  ...
  textSize(25)
  textFont(f1)
  text("B. Struktur Perangkat Desa Kota Dalam",10,1460)
  image(bagan,0,1460,1410,720)
  text("C. Diagram Kependudukan Desa Kota Dalam",10,2200)
  text ("D. Peta Desa KOTA DALAM",0,4510)
}
...
function diagram1(diameter, diagramUsia) {
  ...
  text("60 tahun ke atas  = 2839",40,2640)
  fill(warna[0]) ;
  rect(330,2505,20,10);
  fill(warna[1]) ;
  rect(330,2530,20,10);
  ...
  text('Jadi total jumlah penduduk pada tahun 2022 ada sebanyak 2660 jiwa.',440,2535)
}
...
function diagram4(diameter, diagramJenisKelamin) {
  ...
  fill(0)
  text('Berdasarkan diagram jenis kelamin disampiing, desa Kota Dalam Kecamatan Sidomulyo memiliki',440,3890)
